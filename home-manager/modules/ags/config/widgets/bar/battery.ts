...
import { battery } from "utils/services";

const componentClass = "battery";

const classNames = Utils.merge([battery.bind("percent"), battery.bind("charging")], (percentage, charging) => {
